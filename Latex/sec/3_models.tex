...
%-------------------------------------------------------------------------
\subsection{Ensemble}
Eventually, a simple ensemble model was implemented by combining the predictions of five base learners: Logistic Regression, K-Nearest Neighbors, Decision Tree, Random Forest and XGBoost. The ensemble prediction was obtained through majority voting among the individual model outputs. This approach provided a more stable and robust performance, leveraging the complementary strengths of both simple and ensemble-based classifiers.
