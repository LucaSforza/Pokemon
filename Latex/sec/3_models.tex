...
After that, a \textit{model selection} process was carried out by training and optimizing several machine learning models to predict the outcome of each Pokémon battle.
