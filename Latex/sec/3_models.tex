...
After that, a \textit{model selection} process was carried out by training and optimizing several machine learning models to predict the outcome of each Pokémon battle. Hyperparameter tuning was performed through a combination of grid and randomized search strategies, using validation accuracy as the main performance metric. The best configurations and their corresponding accuracies are summarized in Table.~\ref{tab:best_params}.
